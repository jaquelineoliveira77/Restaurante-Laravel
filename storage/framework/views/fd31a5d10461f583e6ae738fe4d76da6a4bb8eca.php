<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 id="id-h2-pedido" class="text-center">Pedido</h2>
            ...
            <div class="col-md-3">
                ...
                <select id= "select-produto" class="form-select my-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jaqueline Oliveira\Desktop\Ciência da Computação - IFSC\6 ª Fase\Tópicos Especiais Em Programação\Trabalho\RestauranteLaravel\RestauranteLaravel\resources\views/PedidoAdmin/index.blade.php ENDPATH**/ ?>