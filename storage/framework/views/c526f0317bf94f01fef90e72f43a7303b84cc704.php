        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div id="list-pedidos" class="list-group my-3 overflow-auto">
                    <a href="#" class="list-group-item list-group-item-action">Pedido 12</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Jaqueline Oliveira\Desktop\Ciência da Computação - IFSC\6 ª Fase\Tópicos Especiais Em Programação\RestauranteLaravel\resources\views/PedidoAdmin/index.blade.php ENDPATH**/ ?>